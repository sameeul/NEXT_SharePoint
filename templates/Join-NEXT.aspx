			...
			<td>
				<table border="0" cellspacing="0" width="100%">
					...
					<tr>
						<td width="190px" valign="top" class="ms-formlabel">
							<H3 class="ms-standardheader">
								<nobr>Email Address<span class="ms-formvalidation"> *</span>
								</nobr>
							</H3>
						</td>
						<td width="400px" valign="top" class="ms-formbody">
							<SharePoint:FormField runat="server" id="ff2{$Pos}" ControlMode="New" FieldName="Email_x0020_Address" __designer:bind="{ddwrt:DataBind('i',concat('ff2',$Pos),'Value','ValueChanged','ID',ddwrt:EscapeDelims(string(@ID)),'@Email_x0020_Address')}"/>
							<SharePoint:FieldDescription runat="server" id="ff2description{$Pos}" FieldName="Email_x0020_Address" ControlMode="New"/>
						</td>
					</tr>
					<tr>
						<td width="190px" valign="top" class="ms-formlabel">
						...
						<td width="400px" valign="top" class="ms-formbody">
							<SharePoint:FormField runat="server" id="ff3{$Pos}" ControlMode="New" FieldName="Division" __designer:bind="{ddwrt:DataBind('i',concat('ff3',$Pos),'Value','ValueChanged','ID',ddwrt:EscapeDelims(string(@ID)),'@Division')}"/>
							<SharePoint:FieldDescription runat="server" id="ff3description{$Pos}" FieldName="Division" ControlMode="New"/>
						</td>
					</tr>
					<tr>
						<td width="190px" valign="top" class="ms-formlabel">
							<H3 class="ms-standardheader">
								<nobr>Location (City, State)</nobr>
							</H3>
						</td>
						<td width="400px" valign="top" class="ms-formbody">
							<SharePoint:FormField runat="server" id="ff4{$Pos}" ControlMode="New" FieldName="Location_x0020__x0028_City_x002c" __designer:bind="{ddwrt:DataBind('i',concat('ff4',$Pos),'Value','ValueChanged','ID',ddwrt:EscapeDelims(string(@ID)),'@Location_x0020__x0028_City_x002c')}"/>
							<SharePoint:FieldDescription runat="server" id="ff4description{$Pos}" FieldName="Location_x0020__x0028_City_x002c" ControlMode="New"/>
						</td>
					</tr>
					<tr>
						<td width="190px" valign="top" class="ms-formlabel">
							<H3 class="ms-standardheader">
								<nobr>RemoteEmployee</nobr>
							</H3>
						</td>
						<td width="400px" valign="top" class="ms-formbody">
							<SharePoint:FormField runat="server" id="ff5{$Pos}" ControlMode="New" FieldName="field1" __designer:bind="{ddwrt:DataBind('i',concat('ff5',$Pos),'Value','ValueChanged','ID',ddwrt:EscapeDelims(string(@ID)),'@field1')}"/>
							<SharePoint:FieldDescription runat="server" id="ff5description{$Pos}" FieldName="field1" ControlMode="New"/>
						</td>
					</tr>
					<tr>
						<td width="190px" valign="top" class="ms-formlabel">
						...
						<td width="400px" valign="top" class="ms-formbody">
							<SharePoint:FormField runat="server" id="ff6{$Pos}" ControlMode="New" FieldName="field20" __designer:bind="{ddwrt:DataBind('i',concat('ff6',$Pos),'Value','ValueChanged','ID',ddwrt:EscapeDelims(string(@ID)),'@field20')}"/>
							<SharePoint:FieldDescription runat="server" id="ff6description{$Pos}" FieldName="field20" ControlMode="New"/>
						</td>
					</tr>
...
<ParameterBindings>
		 ...
		 <ParameterBinding Name="weburl" Location="None" DefaultValue="https://plconnect.industrysoftware.automation.siemens.com/coi/DiversityERG/NEXT"/>
		 <ParameterBinding Name="ListID" Location="None" DefaultValue="{B65BE0D7-272C-4175-908C-E3AC23074032}"/>
